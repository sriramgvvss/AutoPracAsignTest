/*Class file for all the objects and methods pretaining to New User details submission page of automationpractice My Store app.*/
...
public class NewUserSignUpDetails {
	
	private WebDriver driver;
	
	public NewUserSignUpDetails(WebDriver driver) {
		this.driver = driver;
	}
